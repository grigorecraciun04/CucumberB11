...
public class MainOpenMrsPage {

    public MainOpenMrsPage(WebDriver driver){
    ...
    private WebElement patientRegisterButton;

    public  void registerNewPatientButton(){
        patientRegisterButton.click();
    }
}
